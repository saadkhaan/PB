			...
			<section className="portfolio bg-gray-50 py-8 md:py-32">
				<div className="container">
					...
					<div className="portfolio-container mt-12 md:mt-20">
						<h3 className="block text-2xl font-semibold md:mb-20 md:text-center md:text-5xl">
							Corporate Websites
						</h3>
						<div className="mt-8 grid grid-cols-1 gap-x-4 gap-y-16 md:grid-cols-2">
							...
							<div className="card flex flex-col">
								<div className="card-bg before:bg-neutral-950 relative h-[200px] px-3 pt-6 before:absolute before:-inset-1 before:block before:h-48 before:max-h-max  before:origin-top-left before:scale-x-75 before:transform before:rounded-lg before:transition before:duration-500 before:ease-[cubic-bezier(0.79,0.14,0.15,0.86)] before:hover:scale-x-100 md:h-[300px] md:before:h-72">
									<div className="card__image relative">
										<img
											src="/spade-logo.svg"
