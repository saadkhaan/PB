...
export default function Navbar() {
	...
	return (
		<nav className="w-full border-b border-b-gray-200 bg-gray-50 md:sticky md:top-0 md:z-10 md:bg-gray-50/70 md:shadow-sm md:backdrop-blur-lg">
			<div className="container mx-auto justify-between px-4 md:flex md:items-center">
				<div className="flex items-center justify-between py-3 md:block md:py-5">
					...
					<div className="md:hidden">
						<button
							className="rounded-md p-2 text-gray-800 outline-none focus:border focus:border-gray-400"
				...
				<div>
					...
					>
						<ul className="items-center justify-center space-y-8 md:flex md:space-x-10 md:space-y-0">
							...
							<li className="group rounded-md border border-gray-200 bg-white text-gray-800 transition-all duration-200 hover:bg-green-500">
								<Link href="/contact" legacyBehavior>
									<a className="flex items-center space-x-2 px-6 py-3 transition-all duration-200 hover:shadow-xl group-hover:text-white">
